...
export default function ThemeChanger() {
    ...
    function light() {
        ...
        //        body.attributes.data-theme = theme;
    ...
    return (
        <label className="swap swap-rotate">
            ...
            <input type="checkbox" onClick={light} />

            {/* sun icon */}
            <svg className="swap-on fill-current w-10 h-10"
            ...
            {/* moon icon */}
            <svg className="swap-off fill-current w-10 h-10"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24">
